package com.ostro.databindingmvvm.util;
...
public class NetworkUtils {
    ...
    public static boolean is422(Throwable e) {
        return (getHttpCode(e) == 422) ||
                ((e.getCause() instanceof HttpException && ((HttpException) e.getCause()).code() == 422));
    }

    public static int getHttpCode(Throwable e) {
        return e instanceof HttpException ? ((HttpException) e).code() : 0;
    }
}
